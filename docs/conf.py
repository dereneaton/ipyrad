# -*- coding: utf-8 -*-
#
# ipyrad documentation build configuration file, created by
...
project = u'ipyrad'
copyright = u'2015, Deren Eaton'
author = u'Deren Eaton'
...
# version = "0.1.38"  ##ipyrad.__version__
# # The full version, including alpha/beta/rc tags.
# release = "0.1.38"  ##ipyrad.__version__
...
latex_documents = [
  (master_doc, 'ipyrad.tex', u'ipyrad Documentation',
   u'Deren Eaton', 'manual'),
]
...
man_pages = [
    (master_doc, 'ipyrad', u'ipyrad Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ipyrad', u'ipyrad Documentation',
   author, 'ipyrad', 'One line description of project.',
   'Miscellaneous'),
]
