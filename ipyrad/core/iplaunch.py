...
This code is modified from clustermanager.py which is part of the 
ipyparallel module, and which was released under:
...
class ClusterManager(LoggingConfigurable):
    ...
    def start_cluster(self, profile, cluster_id, n=None):
        """Start a cluster for a given profile ** and cluster_id **."""
        self.check_profile(profile)
