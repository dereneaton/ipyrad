...
Conda install
-------------
ipyrad is available for Python >=2.7 and >=3.5 (we recommend using Python >3.5).
...
later if you install some software dependencies with or without it. 
...
-----------------------------------
You can alternatively install ipyrad from its source code on GitHub. This is not recommended unless you're involved in development or need the latest cutting-edge
releases.
