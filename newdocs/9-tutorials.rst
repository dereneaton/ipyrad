...
The *ipyrad* command line interface (CLI) can be accessed through a terminal.
Use the -help (-h) flag to see a description of the main arguments to the CLI. 
Detailed instructions are available through the tutorials below. 
