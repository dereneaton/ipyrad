...
\title{ipyrad: interactive assembly and analysis of RAD-seq data sets}

\author[1]{Deren A. R. Eaton}
\author[2]{Isaac Overcast}
\affil[1]{Address of first author}
\affil[2]{Address of second author}
\corrauthor[1]{Deren A. R. Eaton}{deren.eaton@yale.edu}
...
Writing introduction here using emacs on my computer instead of overleaf. Now saving these changes to see if they appear on overleaf. Your introduction goes here! Some examples of commonly used commands and features are listed below, to help you get started.
